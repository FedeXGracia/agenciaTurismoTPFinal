<%-- 
    Document   : mostrar_ventas
    Created on : 19/12/2021, 17:53:40
    Author     : FEDEX
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Visualización Ventas</title>
            ...
            <table class="table table-condensed table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <%  HttpSession mySession = request.getSession();
                        List<Sale> salesList = (List) request.getSession().getAttribute("salesList");
                    ...
                    <tr>  
                        ...
                        <td><%=saleNumber%></td>
                        <%String payMethod = sale.getPayMethod();%>
                        <td><%=payMethod%></td>
                        <%String saleDate = sale.getSaleDate();%>
                        <td><%=saleDate%></td>

                        <%int id = sale.getSaleNumber();%>
                        <td>
                            <form name="deleteSale" action="SvDeleteSale" method="POST" style="display: inline">
                                <input type="hidden" name="id" value="<%=id%>">
                                <button type="submit" class="btn btn-danger btn-xs" data-title="Delete" style="display: inline">ELIMINAR</button>
                            </form>
                        </td>
                        <td>
                            <form name="editSale" action="SvEditSale" method="POST" style="display: inline">
                                <input type="hidden" name="id" value="<%=id%>">
