<%-- 
    Document   : alta_ventas
    Created on : 19/12/2021, 16:32:11
    Author     : FEDEX
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="contact-form">
                            ...
                            <form id="contact" action="SvSale" method="POST">

                                <h6 style="background-color: #ffff66"><b>Ingrese los datos de la VENTA</b></h6>
                                <br>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input name="payMethod" type="text" id="payMethod" placeholder="Ingrese MÉTODO DE PAGO" required="">
                                            <%Controller control = new Controller();%>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input name="saleDate" type="text" id="saleDate" placeholder="Ingrese FECHA DE VENTA (dd/mm/yyyy)" required="">
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="main-button">REGISTRAR VENTA</button>
                                        </fieldset>
                                    </div>
