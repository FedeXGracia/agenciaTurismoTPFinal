<%-- 
    Document   : encontrado_servicio
    Created on : 19/12/2021, 16:13:50
    Author     : FEDEX
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Servicio encontrado</title>
            ...
            <table class="table table-condensed table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <%  HttpSession mySession = request.getSession();
                        TouristService tS = (TouristService) request.getSession().getAttribute("touristService");
                    %>
