<%-- 
    Document   : buscar_clientes
    Created on : 18/12/2021, 22:05:43
    Author     : FEDEX
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class ="container search">
            <form class="form" action="SvSearchClient" method="POST">
                <input class="form-control" type="text" name="id" placeholder="Ingrese ID Cliente" required="">
