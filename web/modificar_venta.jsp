<%-- 
    ...
    Created on : 19/12/2021, 18:24:15
    Author     : FEDEX
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="contact-form">
                            <form id="contact" action="SvEditSale" method="GET"> <!--Usar PUT o POST, el GET es una prueba-->
                                <%  HttpSession mySession = request.getSession();
                                    Sale sale = (Sale) mySession.getAttribute("sale");
                                    {%>

                                <h6>Modificar datos de la VENTA</h6>
                                <br>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="payMethod" type="text" id="payMethod" placeholder="Ingrese MÉTODO DE PAGO" required="" value="<%=sale.getPayMethod()%>">
                                        </fieldset>
                                    </div>

                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="saleDate" type="text" id="saleDate" placeholder="Ingrese FECHA DE VENTA (dd/mm/yyyy)" required="" value="<%=sale.getSaleDate()%>">
                                        </fieldset>
                                    </div>

                                    <div class="col-lg-12">
                                        <input type="hidden" name="id" value="<%=sale.getSaleNumber()%>">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="btn btn--radius btn--green">ACTUALIZAR VENTA</button>
                                        </fieldset>
                                    </div>
