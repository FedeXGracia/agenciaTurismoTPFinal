<%-- 
    ...
    Created on : 18/12/2021, 18:05:30
    Author     : FEDEX
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="contact-form">
                            <form id="contact" action="SvClients" method="POST">

                                <h6 style="background-color: #99ccff"><b>Ingrese los datos del CLIENTE</b></h6>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="main-button">REGISTRAR CLIENTE</button>
                                        </fieldset>
                                    </div>
