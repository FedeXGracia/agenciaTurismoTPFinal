<%-- 
    Document   : buscar_ventas
    Created on : 19/12/2021, 19:03:29
    Author     : FEDEX
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class ="container search">
            <form class="form" action="SvSearchSale" method="POST">
                <input class="form-control" type="text" name="id" placeholder="Ingrese ID Venta" required="">
