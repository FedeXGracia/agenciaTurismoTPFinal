<%-- 
    Document   : modificar_servicio
    Created on : 19/12/2021, 15:12:21
    Author     : FEDEX
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="contact-form">
                            <form id="contact" action="SvEditService" method="GET"> <!--Usar PUT o POST, el GET es una prueba-->
                                <%  HttpSession mySession = request.getSession();
                                    TouristService tS = (TouristService) mySession.getAttribute("touristService");
                                    {%>

                                <h6>Modificar datos del SERVICIO</h6>
                                <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="name" type="text" id="name" placeholder="Ingrese NOMBRE" required="" value="<%=tS.getName()%>">
                                        </fieldset>
                                    </div>

                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="briefDescription" type="text" id="briefDescription" placeholder="Ingrese DESCRIPCIÓN" required="" value="<%=tS.getBriefDescription() %>">
                                        </fieldset>
                                    </div>

                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="serviceDestiny" type="text" id="serviceDestiny" placeholder="Ingrese DESTINO" required="" value="<%=tS.getServiceDestiny()%>">
                                        </fieldset>
                                    </div>

                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="serviceCost" type="text" id="serviceCost" placeholder="Ingrese PRECIO" required="" value="<%=tS.getServiceCost()%>">
                                        </fieldset>
                                    </div>

                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="serviceDate" type="text" id="serviceDate" placeholder="Ingrese FECHA de contratación de servicio (dd/mm/yyyy)" required="" value="<%=tS.getServiceDate()%>">
                                        </fieldset>
                                    </div>
                                    ...
                                    <br>
                                    <div class="col-lg-12">
                                        <input type="hidden" name="id" value="<%=tS.getServiceCode()%>">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="main-button">ACTUALIZAR SERVICIO</button>
                                        </fieldset>
                                    </div>
