<%-- 
    Document   : buscar_paquetes
    Created on : 20/12/2021, 20:47:41
    Author     : FEDEX
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class ="container search">
            <form class="form" action="SvSearchPackage" method="POST">
                <input class="form-control" type="text" name="id" placeholder="Ingrese ID Paquete" required="">
