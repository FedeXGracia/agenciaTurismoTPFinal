<%-- 
    Document   : modificar_paquete
    Created on : 20/12/2021, 19:55:48
    Author     : FEDEX
--%>

<%@page import="logica.TouristPackage"%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="contact-form">
                            <form id="contact" action="SvEditPackage" method="GET"> <!--Usar PUT o POST, el GET es una prueba-->
                                <%  HttpSession mySession = request.getSession();
                                    TouristPackage tP = (TouristPackage) mySession.getAttribute("touristPackage");
                                    {%>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input class="input--style-1" name="packageCost" type="text" id="packageCost" placeholder="Ingrese pRECIO DEL PAQUETE" required="" value="<%=tP.getPackageCost()%>">
                                        </fieldset>
                                    </div>

                                    <div class="col-lg-12">
                                        <input type="hidden" name="id" value="<%=tP.getPackageCode()%>">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="btn btn--radius btn--green">ACTUALIZAR PAQUETE</button>
                                        </fieldset>
                                    </div>
