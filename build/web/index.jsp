<%-- 
    Document   : index
    Created on : 02/12/2021, 01:14:23
    Author     : FEDEX
--%>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="index.jsp" class="logo"><em>cuyo</em> tour</a>
                            <!-- ***** Logo End ***** -->
                            <!-- ***** Menu Start ***** -->
                            <ul class="nav">
                                <!--li class="scroll-to-section"><a href="#top" class="active">Inicio</a></li-->
                                <!--li class="scroll-to-section"><a href="#features">Servicios</a></li-->
                                <!--li class="scroll-to-section"><a href="buscar.jsp">Búsqueda</a></li-->
                                ...
                                <li class="main-button" ><a href="#contact-us" style="color:white!important">Soporte</a></li>
                            </ul>        
        ...
        <div class="main-banner" id="top">
            <video autoplay muted loop id="bg-video">
                <source src="assets/agency_images/Mountains - 48873.mp4" type="video/mp4" />
            </video>

            <div class="video-overlay header-text">
                <div class="caption">
                    <h6>estemos cerca, viajemos lejos</h6>
                    <h2>bienvenidos a <em>cuyotour</em></h2>
                    <div class="main-button scroll-to-section">
                        <a href="#features">únase al viaje</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div id="map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3350.3229317597284!2d-68.84511155209361!3d-32.889629154556026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x967e0907b3f6324b%3A0x501d1521958dfb21!2sPlaza%20Independencia!5e0!3m2!1ses!2sus!4v1638882357242!5m2!1ses!2sus" width="100%" height="600px" frameborder="0" style="border:0" allowfullscreen loading="lazy"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12">
                            ...
                            <form id="contact" action="" method="post">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input name="name" type="text" id="name" placeholder="Ingrese su Nombre*" required="">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input name="email" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Ingrese su Correo*" required="">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                            <input name="subject" type="text" id="subject" placeholder="Asunto de la Consulta">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-12">
                                        <fieldset>
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="main-button">Enviar Consulta</button>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
