<%-- 
    Document   : buscar_servicios
    Created on : 19/12/2021, 16:11:53
    Author     : FEDEX
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class ="container search">
            <form class="form" action="SvSearchService" method="POST">
                <input class="form-control" type="text" name="id" placeholder="Ingrese ID Servicio" required="">
